...
generate_sdks: generate_nodejs generate_go
build_sdks: build_nodejs build_go
install_sdks: install_nodejs_sdk install_go_sdk
...
# `cmd/pulumi-resource-deltastream/schema.json` is valid and up to date.
