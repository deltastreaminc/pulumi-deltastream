...
namespace DeltaStream.Pulumi
{
    ...
    ///     });
    /// 
    ///     var exampleNamespace = new Pulumi.Namespace("example", new()
    ///     {
    ...
    /// ```
    /// </summary>
    [PulumiResourceType("deltastream:index/namespace:Namespace")]
    public partial class Namespace : global::Pulumi.CustomResource
    {
        ...
        public Namespace(string name, NamespaceArgs args, CustomResourceOptions? options = null)
            : base("deltastream:index/namespace:Namespace", name, args ?? new NamespaceArgs(), MakeResourceOptions(options, ""))
        {
        }

        private Namespace(string name, Input<string> id, NamespaceState? state = null, CustomResourceOptions? options = null)
            : base("deltastream:index/namespace:Namespace", name, state, MakeResourceOptions(options, id))
        {
        }
