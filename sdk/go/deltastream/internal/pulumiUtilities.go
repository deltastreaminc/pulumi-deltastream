...
func PkgVersion() (semver.Version, error) {
	...
	re := regexp.MustCompile("^.*/pulumi-deltastream/sdk(/v\\d+)?")
...
func PkgResourceDefaultOpts(opts []pulumi.ResourceOption) []pulumi.ResourceOption {
	...
	defaults = append(defaults, pulumi.PluginDownloadURL("https://github.com/deltastreaminc/pulumi-deltastream/releases/download/v${VERSION}/"))
